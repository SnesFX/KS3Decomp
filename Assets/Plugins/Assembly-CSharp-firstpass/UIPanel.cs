...
public class UIPanel : UIRect
{
	...
	private void Awake()
	{
		...
		mHalfPixelOffset = Application.platform == RuntimePlatform.WindowsPlayer || Application.platform == RuntimePlatform.PSP2 || Application.platform == RuntimePlatform.WindowsEditor;
		if (mHalfPixelOffset)
		{
